...
GGML_API void quantize_row_mxfp6_e2m3_ref(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_mxfp6_e2m3(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_mxfp6_e2m3_tile(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_q2_K_rsf(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * quant_weights, int32_t mode);
...
GGML_API size_t quantize_q3_K_rsf(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * quant_weights, int32_t mode);
...
GGML_API size_t quantize_q4_K_rsf(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * quant_weights, int32_t mode);
...
GGML_API size_t quantize_q5_K_rsf(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * quant_weights, int32_t mode);
...
GGML_API size_t quantize_q6_K_rsf(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * quant_weights, int32_t mode);
