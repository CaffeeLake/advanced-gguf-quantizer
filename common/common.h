...
struct common_params {
    ...
    bool graph_reuse_disable = false; // disable graph reuse for calibration tools that patch loaded tensors
    ...
    bool        logits_file_resume   = false; // resume/appending --save-all-logits output                  // NOLINT
    ...
    bool use_mmap_prefetch = true;  // pre-fault mmap model pages during load
    ...
    // Legacy upstream-compatible multimodal projector params.
