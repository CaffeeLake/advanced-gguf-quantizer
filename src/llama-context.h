...
struct llama_context {
    ...
    const ggml_tensor * get_logits_tensor_internal() const;
    ggml_backend_t      get_logits_backend_internal() const;
    ...
    void set_selector_gpu_kld_active(bool value);
...
private:
    ...
    bool selector_gpu_kld_active = false;
