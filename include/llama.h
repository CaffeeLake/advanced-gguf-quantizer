...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_MXFP6_E2M3    = 41, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_MXFP4         = 44, // except 1d tensors

        LLAMA_FTYPE_GUESSED = 1024, // not specified in the model file
    };

    enum llama_nvfp4_input_scale_policy {
        LLAMA_NVFP4_INPUT_SCALE_IMATRIX_RMS      = 0,
        LLAMA_NVFP4_INPUT_SCALE_IDENTITY         = 1,
        LLAMA_NVFP4_INPUT_SCALE_IMATRIX_SQRTMAX  = 2,
        LLAMA_NVFP4_INPUT_SCALE_IMATRIX_SQRTP99  = 3,
        LLAMA_NVFP4_INPUT_SCALE_IMATRIX_SQRTP999 = 4,
    };

    enum llama_nv4mx6_policy {
        LLAMA_NV4MX6_POLICY_OFF             = 0,
        LLAMA_NV4MX6_POLICY_MX6_SLOT        = 1,
        LLAMA_NV4MX6_POLICY_NV4_PROMOTE_MX6 = 2,
        LLAMA_NV4MX6_POLICY_MX6_DEMOTE_NV4  = 3,
        LLAMA_NV4MX6_POLICY_AUTO            = 4,
        LLAMA_NV4MX6_POLICY_BF16_MX6        = 5,
        LLAMA_NV4MX6_POLICY_BF16_MX6_SSE    = 6,
    };
    ...
    struct llama_model_params {
        ...
        bool use_mmap_prefetch; // pre-fault mmap pages while loading the model
    ...
    struct llama_context_params {
        ...
        bool graph_reuse_disable; // disable graph reuse for callers that mutate tensor buffers between evals
    ...
    typedef struct llama_model_quantize_params {
        ...
        void * tensor_types;                                        // pointer to vector containing tensor types with extended NVFP4 cfg
        const int32_t * prune_layers;                               // pointer to layer indices to prune
        const char * patch_base_model;                              // optional quantized GGUF to reuse unchanged tensor bytes from
        int32_t nv4mx6_policy;                                      // NVFP4/MXFP6 selector policy
        float nv4mx6_mx6_penalty;                                   // selector cost penalty for MXFP6
        float nv4mx6_bf16_mx6_max_sse_ratio;                        // BF16->MXFP6 SSE threshold
        bool mxfp6_tensor_scale;                                    // write MXFP6 tensor correction scales
        int64_t mxfp6_min_savings_bytes;                            // minimum automatic MXFP6 space saving
        ...
        int32_t mxfp6_tensor_scale_steps;                            // MXFP6 tensor-scale search steps, 0 = default
        int64_t mixed_format_sample_blocks;                          // NVFP4/MXFP6 proxy sample blocks, 0 = automatic
        int64_t mixed_format_sample_cap;                             // NVFP4/MXFP6 proxy sample cap, 0 = default
        float mixed_format_imatrix_blend;                            // mixed-format imatrix weight blend, negative = default
        ...
        bool k_quant_rsf;                                             // K-quant refined scale fit for Q2_K through Q6_K
        int32_t k_quant_rsf_mode;                                     // 1=scale fit, 2=AWQ-style, 3=SQ-style
...
#define LLAMA_STATE_SEQ_FLAGS_ON_DEVICE 2
    ...
    /// @details Initializes a GBNF grammar from caller-supplied grammar text.
