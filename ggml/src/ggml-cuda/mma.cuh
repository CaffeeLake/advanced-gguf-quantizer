...
#pragma unroll
	    ...
	    static __device__ __forceinline__ void mma_block_scaled_mxfp6_e2m3(tile<16, 8, float> &     D,
                                                                       const tile<16, 8, int> & A,
                                                                       const tile<8, 8, int> &  B,
                                                                       uint32_t                 a_scale,
                                                                       uint32_t                 b_scale) {
    ...
    static __device__ __forceinline__ void mma_block_scaled_fp8_e4m3(tile<16, 8, float> &     D,
                                                                       const tile<16, 8, int> & A,
                                                                       const tile<8, 8, int> &  B,
                                                                       uint32_t                 a_scale,
                                                                       uint32_t                 b_scale) {
    ...
    static __device__ __forceinline__ void mma_block_scaled_mxfp4_e2m1_mxfp6_e2m3(tile<16, 8, float> &     D,
                                                                                  const tile<16, 8, int> & A,
                                                                                  const tile<8, 8, int> &  B,
                                                                                  uint32_t                 a_scale,
                                                                                  uint32_t                 b_scale) {
    ...
    static __device__ __forceinline__ void mma_block_scaled_mxfp4_e2m1_fp8_e4m3(tile<16, 8, float> &     D,
                                                                                  const tile<16, 8, int> & A,
                                                                                  const tile<8, 8, int> &  B,
                                                                                  uint32_t                 a_scale,
                                                                                  uint32_t                 b_scale) {
